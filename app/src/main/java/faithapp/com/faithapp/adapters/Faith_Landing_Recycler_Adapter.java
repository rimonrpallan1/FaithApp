 ...
 */
public class Faith_Landing_Recycler_Adapter extends RecyclerView.Adapter<Faith_Landing_Recycler_Adapter.ChurchDetailViewHolder>{

    List<Landing_Card_Details> church_detail;
    private Activity activity;
    Boolean isVisible = true;

    public Faith_Landing_Recycler_Adapter(Activity activity,List<Landing_Card_Details> church_detail){
